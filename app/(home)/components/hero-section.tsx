        ...
        <div className='min-h-[60vh] flex flex-col-reverse gap-14 lg:gap-0 lg:flex-row items-center justify-between'>
            <div className='space-y-10 text-center lg:text-left'>
                <h1 className='text-4xl lg:text-7xl font-bold'>Nice to meet you!👋 <br />
                    <span className='underline underline-offset-8 decoration-green-500'>{"I'm Andhika."}</span>
                </h1>
                <p className='md:w-96 text-lg text-gray-300'>
                    {"Based in East Kalimantan, I'm a Fullstack developer passionate about building a modern web and mobile application that users love."}
                </p>
                <Link href={"mailto:adkprtm00@gmail.com"} className='inline-block group'>
